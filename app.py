...
import warnings
from analysis_tools import calculate_bucket_raw_metrics, calculate_bucket_correlation_metrics
                ...
                with tab1:
                    ...
                    if show_correlation and len(variable_cols) >= 2:
                        if use_spread_analysis:
                            ...
                            from analysis_tools import calculate_spread_metrics
                            ...
                            if use_weighted_correlation:
                                from analysis_tools import calculate_weighted_correlation
                        ...
                        if start_hour >= end_hour:
                            ...
                            if len(time_filtered_data) > 0:
                                ...
                                if use_spread_analysis:
                                    ...
                                    from analysis_tools import calculate_bucket_spread_metrics
